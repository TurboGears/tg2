...
from blogtutorial.config.environment import load_environment
import blogtutorial.lib.helpers
import blogtutorial.lib.app_globals as app_globals
...
def make_app(global_conf, full_stack=True, **app_conf):
    ...
    config.init_app(global_conf, app_conf, package='blogtutorial', template_engine='pylonsmyghty')
    
    # Load our default Pylons WSGI app and make g available
    app = pylons.wsgiapp.PylonsApp(config, helpers=blogtutorial.lib.helpers,
